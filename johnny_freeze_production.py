...
# Excel file path
excel_file = "/Users/jyoung/Documents/JohnnyFreeze/johnny_freeze_production.xlsx"
...
def flavor_page(flavor_name):
    ...
    number = st.number_input(f"How many cups of {flavor_name} produced:", min_value=0, value=0)
    ...
    if st.button("Submit Production"):
        ...
        st.success(f"✅ Saved {number} cups of {flavor_name} produced for {selected_date}!")
...
if st.session_state.page == "home":
    st.title("Johnny Freeze Production Inputs")
    st.write("Select a flavor to enter its daily production data.")
